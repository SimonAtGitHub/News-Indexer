...
public class Token {
    ...
    private boolean isFirstWordInSent = false;
    ...
    public String toString() {
		//TODO: YOU MUST IMPLEMENT THIS METHOD
        //TODO: Sankar- Yet to be tested for the mentioned business logic
        return String.copyValueOf(getTermBuffer());
    }

    public boolean isFirstWordInSent() {
        return this.isFirstWordInSent;
    }

    public void setFirstWordInSentFlag(boolean a) {
        this.isFirstWordInSent = a;
    }
