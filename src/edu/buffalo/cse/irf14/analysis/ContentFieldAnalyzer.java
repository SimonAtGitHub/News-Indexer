 ...
 * @author san
 */
public class ContentFieldAnalyzer implements Analyzer{

    private TokenStream stream;
    
    public ContentFieldAnalyzer(TokenStream stream) {
    ...
    public boolean increment() throws TokenizerException {
        ...
        try {
            ...
            //TODO: Harish - check Merge and enable the below filter
