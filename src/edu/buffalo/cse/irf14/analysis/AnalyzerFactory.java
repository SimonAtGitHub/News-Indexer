...
public class AnalyzerFactory {
        ...
        private static final AnalyzerFactory analyzerFact = new AnalyzerFactory();
	...
	public Analyzer getAnalyzerForField(FieldNames name, TokenStream stream) {
		...
		switch (name) {
		case CONTENT:
			out = new ContentFieldAnalyzer(stream);
			break;
		case TITLE:
			out = new TitleFieldAnalyzer(stream);
                        break;
		case PLACE:
			out = new PlaceFieldAnalyzer(stream);
                        break;
		case NEWSDATE:
                        out = new NewsDateFieldAnalyzer(stream);
			break;
		case AUTHOR:
			out = new AuthorFieldAnalyzer(stream);
                        break;
		case AUTHORORG:
			out = new AuthorOrgFieldAnalyzer(stream);
                        break;
		case CATEGORY:
			out = new CategoryFieldAnalyzer(stream);
                        break;
		case FILEID:
			out = new FileIdFieldAnalyzer(stream);
			break;		
		}
